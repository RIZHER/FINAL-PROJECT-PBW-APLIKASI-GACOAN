...
<html lang="en">
 ...
 <!-- Form Registrasi -->
  ...
  if(isset($_POST['tambah'])){
    ...
    $cek_max = mysqli_query($conn, "SELECT MAX(id_menu) AS max_id FROM menu");
    $max = $cek_max -> fetch_assoc() + 1;
    $id_menu = $max['max_id'] + 1;
    $insert = mysqli_query($conn, "INSERT INTO menu VALUES ($id_menu, '$nama', '$harga', '$nama_file')");
