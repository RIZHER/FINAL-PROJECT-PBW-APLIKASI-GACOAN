...
<html lang="en">
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="admin.php"><strong>Mie Gacoan</strong></a>
      ...
      <table class="table table-bordered" id="example">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="detail_pesanan.php?id=<?php echo $result['kode_transaksi'] ?>" class="badge badge-primary">Detail</a>
              <a href="clear_pesanan.php?id=<?php echo $result['kode_transaksi'] ?>" class="badge badge-danger">Hapus Data</a>
            </td>
          </tr>
          <?php $nomor++; ?>
          <?php endforeach; ?>
