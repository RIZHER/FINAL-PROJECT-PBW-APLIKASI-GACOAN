    ...
    <div class="container">
      ...
      <table class="table table-bordered" id="example">
        ...
        <tbody>
          ...
          $nomor=1; 
          $totalbelanja = 0; 
          $ambil = $conn->query("SELECT * FROM `detailtransaksi` JOIN menu ON detailtransaksi.id_menu=menu.id_menu
          ...
          <tr>
            ...
            <td>
              Rp. <?php echo $pecah['total_harga']; ?>
            </td>
          </tr>
          <?php
          $nomor++;
          $totalbelanja += $pecah['total_harga'];
          } ?>
        </tbody>
         <tfoot>
          <tr>
