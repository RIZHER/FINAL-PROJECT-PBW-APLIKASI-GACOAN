...
<html lang="en">
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="./admin.php?status=<?php echo $status?>"><strong>Mie Gacoan</strong></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link mr-4" href="./admin.php?status=<?php echo $status?>"?>HOME</a>
            </li>
            <li class="nav-item">
              <?php
              if($status == 1){ ?>
                ...
                <a class="nav-link mr-4" href="./daftar_menu.php" style="pointer-events: none;">DAFTAR MENU</a>
              <?php
              }
              ?>
            </li>
  ...
  <!-- Menu -->    
      <div class="container">
        <div class="judul text-center mt-5">
          <h3 class="font-weight-bold">Mie Gacoan</h3>
          <h5>Jimbaran, Badung, Bali
          <br>Buka <strong>24 Jam</strong></h5>
        </div>

        <div class="row mb-5 mt-5 ">
          <div class="col-md-6 d-flex justify-content-end">
            <div class="card bg-dark text-white border-light">
              <img src="img/galeri1.png" class="card-img" alt="Lihat Daftar Menu">
              <div class="card-img-overlay mt-5 text-center">
                ...
                if($status == 1){ ?>
                  ...
                  <a href="./daftar_menu.php" class="btn btn-primary" style="pointer-events: none;">LIHAT DAFTAR MENU</a>
                <?php
                }
                ?>
              </div>
          ...
          <div class="col-md-6 d-flex justify-content-start">
            <div class="card bg-dark text-white border-light">
              <img src="img/galeri2.png" class="card-img" alt="Lihat Pesanan">
              <div class="card-img-overlay mt-5 text-center">
